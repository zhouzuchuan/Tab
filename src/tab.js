 ...
 * @Modified Time: 2016-05-11 09:32:23
 */
...
;(function ($, window, document) {
    ...
    Tab.prototype = {
        ...
        set: function (idx) {
            var self = this,
                // 获取当前的跟踪值
                traceValue = this.info[idx].trace,
                dealCur = this._dealClass()[traceValue];
            // 判断当前状态是否选中
            if (self.info[idx].current) return;
            ...
            // 设值
            addClass(dealCur.btn, this.info[idx].node[0]);
            addClass(dealCur.main, this.info[idx].node[1]);

            self.info[idx].current = true;
        },
        _getDom: function () {
